...
class ViewController: UIViewController {
    ...
    // monster and bubbles both use this function and we get the name of the asset from the button which shares the same name
    ...
    // guitar and applause have dedicated buttons
